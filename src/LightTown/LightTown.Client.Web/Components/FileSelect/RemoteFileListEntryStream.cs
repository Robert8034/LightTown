...
namespace LightTown.Client.Web.Components.FileSelect
{
    internal class RemoteFileListEntryStream : FileListEntryStream
    {
        ...
        public RemoteFileListEntryStream(IJSRuntime jsRuntime, ElementReference inputFileElement, FileListEntry file, int maxMessageSize, int maxBufferSize)
